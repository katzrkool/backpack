...
def genHTML(data, urlRoot):
    ...
    with doc:
        ...
        footer(raw('<p>Arrows made by <a href="https://fontawesome.com">Font Awesome</a>.\n<a href="https://fontawesome.com/license/free">License</a>. No changes to images were made. <a href="faq">Information/FAQ</a>. Press "c" to expand/collapse all assignments'))
